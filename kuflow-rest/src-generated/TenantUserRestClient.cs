...
namespace KuFlow.Rest
{
  internal partial class TenantUserRestClient
  {
    ...
    internal HttpMessage CreateFindTenantUsersRequest(
      int? size,
      int? page,
    ...
    )
    {
      ...
      if (
        groupId != null
        && !(groupId is ChangeTrackingList<Guid> changeTrackingList0 && changeTrackingList0.IsUndefined)
      )
      {
      ...
      if (
        email != null
        && !(email is ChangeTrackingList<string> changeTrackingList1 && changeTrackingList1.IsUndefined)
      )
      {
      ...
      if (
        tenantId != null
        && !(tenantId is ChangeTrackingList<Guid> changeTrackingList2 && changeTrackingList2.IsUndefined)
      )
      {
    ...
    ///
    /// </remarks>
    public async Task<Response<TenantUserPage>> FindTenantUsersAsync(
      int? size = null,
      int? page = null,
    ...
    public async Task<Response<TenantUser>> RetrieveTenantUserAsync(
      Guid id,
      CancellationToken cancellationToken = default
    )
    {
