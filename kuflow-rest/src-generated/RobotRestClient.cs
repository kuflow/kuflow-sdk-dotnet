...
namespace KuFlow.Rest
{
  internal partial class RobotRestClient
  {
    ...
    internal HttpMessage CreateFindRobotsRequest(
      int? size,
      int? page,
    ...
    ///
    /// </remarks>
    public async Task<Response<RobotPage>> FindRobotsAsync(
      int? size = null,
      int? page = null,
    ...
    ///
    /// </remarks>
    public Response<RobotPage> FindRobots(
      int? size = null,
      int? page = null,
      IEnumerable<string> sort = null,
      IEnumerable<Guid> tenantId = null,
    ...
    public async Task<Response<Stream>> DownloadRobotSourceCodeAsync(
      Guid id,
      CancellationToken cancellationToken = default
    )
    {
    ...
    internal HttpMessage CreateDownloadRobotAssetRequest(
      Guid id,
      RobotAssetType type,
      string version,
    ...
    public async Task<Response<Stream>> DownloadRobotAssetAsync(
      Guid id,
      RobotAssetType type,
      string version,
      RobotAssetPlatform platform,
    ...
    /// <exception cref="ArgumentNullException"> <paramref name="version"/> is null. </exception>
    /// <remarks> Given a robot, download the requested asset. </remarks>
    public Response<Stream> DownloadRobotAsset(
      Guid id,
      RobotAssetType type,
      string version,
      RobotAssetPlatform platform,
