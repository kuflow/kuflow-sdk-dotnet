...
namespace KuFlow.Rest
{
  ...
  public partial class TenantUserClient
  {
    ...
    ///
    /// </remarks>
    internal virtual async Task<Response<TenantUserPage>> FindTenantUsersAsync(
      int? size = null,
      int? page = null,
    ...
    )
    {
      ...
      try
      {
        return await RestClient
          .FindTenantUsersAsync(size, page, sort, groupId, email, tenantId, cancellationToken)
    ...
    ///
    /// </remarks>
    internal virtual Response<TenantUserPage> FindTenantUsers(
      int? size = null,
      int? page = null,
      IEnumerable<string> sort = null,
      IEnumerable<Guid> groupId = null,
    ...
    public virtual async Task<Response<TenantUser>> RetrieveTenantUserAsync(
      Guid id,
      CancellationToken cancellationToken = default
    )
    {
