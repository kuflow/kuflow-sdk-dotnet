...
namespace KuFlow.Rest
{
    ...
    public partial class ProcessItemClient
    {
        ...
        ///
        /// </remarks>
        public virtual async Task<Response<ProcessItem>> CreateProcessItemAsync(ProcessItemCreateParams processItemCreateParams, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("ProcessItemClient.CreateProcessItem");
            scope.Start();
            try
            {
                return await RestClient.CreateProcessItemAsync(processItemCreateParams, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        ///
        /// </remarks>
        public virtual Response<ProcessItem> CreateProcessItem(ProcessItemCreateParams processItemCreateParams, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("ProcessItemClient.CreateProcessItem");
            scope.Start();
            try
        ...
        public virtual async Task<Response<ProcessItem>> RetrieveProcessItemAsync(Guid id, CancellationToken cancellationToken = default)
        {
        ...
        public virtual async Task<Response<ProcessItem>> ClaimProcessItemTaskAsync(Guid id, CancellationToken cancellationToken = default)
        {
        ...
        public virtual async Task<Response<ProcessItem>> AssignProcessItemTaskAsync(Guid id, ProcessItemTaskAssignParams processItemTaskAssignParams, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("ProcessItemClient.AssignProcessItemTask");
            scope.Start();
            try
            {
                return await RestClient.AssignProcessItemTaskAsync(id, processItemTaskAssignParams, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <remarks> Allow to assign a process item task to a user or application. Only one option will be necessary. </remarks>
        public virtual Response<ProcessItem> AssignProcessItemTask(Guid id, ProcessItemTaskAssignParams processItemTaskAssignParams, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("ProcessItemClient.AssignProcessItemTask");
            scope.Start();
            try
        ...
        public virtual async Task<Response<ProcessItem>> CompleteProcessItemTaskAsync(Guid id, CancellationToken cancellationToken = default)
        {
        ...
        ///
        /// </remarks>
        public virtual async Task<Response<ProcessItem>> AppendProcessItemTaskLogAsync(Guid id, ProcessItemTaskAppendLogParams processItemTaskAppendLogParams, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("ProcessItemClient.AppendProcessItemTaskLog");
            scope.Start();
            try
            {
                return await RestClient.AppendProcessItemTaskLogAsync(id, processItemTaskAppendLogParams, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        ///
        /// </remarks>
        public virtual Response<ProcessItem> AppendProcessItemTaskLog(Guid id, ProcessItemTaskAppendLogParams processItemTaskAppendLogParams, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("ProcessItemClient.AppendProcessItemTaskLog");
            scope.Start();
            try
        ...
        ///
        /// </remarks>
        public virtual async Task<Response<ProcessItem>> UpdateProcessItemTaskDataAsync(Guid id, ProcessItemTaskDataUpdateParams processItemTaskDataUpdateParams, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("ProcessItemClient.UpdateProcessItemTaskData");
            scope.Start();
            try
            {
                return await RestClient.UpdateProcessItemTaskDataAsync(id, processItemTaskDataUpdateParams, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        ///
        /// </remarks>
        public virtual Response<ProcessItem> UpdateProcessItemTaskData(Guid id, ProcessItemTaskDataUpdateParams processItemTaskDataUpdateParams, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("ProcessItemClient.UpdateProcessItemTaskData");
            scope.Start();
            try
        ...
        ///
        /// </remarks>
        public virtual async Task<Response<ProcessItem>> PatchProcessItemTaskDataAsync(Guid id, IEnumerable<JsonPatchOperation> jsonPatch, CancellationToken cancellationToken = default)
        {
        ...
        ///
        /// </remarks>
        public virtual Response<ProcessItem> PatchProcessItemTaskData(Guid id, IEnumerable<JsonPatchOperation> jsonPatch, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("ProcessItemClient.PatchProcessItemTaskData");
            scope.Start();
            try
        ...
        /// <summary> Upload a document associated with the process item task data. </summary>
        /// <param name="id"> The resource ID. </param>
        ...
        ///
        /// </remarks>
        public virtual async Task<Response<DocumentReference>> UploadProcessItemTaskDataDocumentAsync(Guid id, string fileContentType, string fileName, string schemaPath, Stream file, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("ProcessItemClient.UploadProcessItemTaskDataDocument");
            scope.Start();
            try
            {
                return await RestClient.UploadProcessItemTaskDataDocumentAsync(id, fileContentType, fileName, schemaPath, file, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        ///
        /// </remarks>
        public virtual Response<DocumentReference> UploadProcessItemTaskDataDocument(Guid id, string fileContentType, string fileName, string schemaPath, Stream file, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("ProcessItemClient.UploadProcessItemTaskDataDocument");
            scope.Start();
            try
            {
                return RestClient.UploadProcessItemTaskDataDocument(id, fileContentType, fileName, schemaPath, file, cancellationToken);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        public virtual async Task<Response<Stream>> DownloadProcessItemTaskDataDocumentAsync(Guid id, string documentUri, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("ProcessItemClient.DownloadProcessItemTaskDataDocument");
            scope.Start();
            try
            {
                return await RestClient.DownloadProcessItemTaskDataDocumentAsync(id, documentUri, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        /// <param name="cancellationToken"> The cancellation token to use. </param>
        /// <remarks> Given a task, download a document from a json form data. </remarks>
        public virtual Response<Stream> DownloadProcessItemTaskDataDocument(Guid id, string documentUri, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("ProcessItemClient.DownloadProcessItemTaskDataDocument");
            scope.Start();
            try
            {
                return RestClient.DownloadProcessItemTaskDataDocument(id, documentUri, cancellationToken);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        ///
        /// </remarks>
        public virtual async Task<Response<Stream>> DownloadProcessItemTaskDataWebformsAsDocumentAsync(Guid id, string propertyPath, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("ProcessItemClient.DownloadProcessItemTaskDataWebformsAsDocument");
            scope.Start();
            try
            {
                return await RestClient.DownloadProcessItemTaskDataWebformsAsDocumentAsync(id, propertyPath, cancellationToken).ConfigureAwait(false);
            }
            catch (Exception e)
            {
                scope.Failed(e);
        ...
        ///
        /// </remarks>
        public virtual Response<Stream> DownloadProcessItemTaskDataWebformsAsDocument(Guid id, string propertyPath, CancellationToken cancellationToken = default)
        {
            using var scope = _clientDiagnostics.CreateScope("ProcessItemClient.DownloadProcessItemTaskDataWebformsAsDocument");
            scope.Start();
            try
