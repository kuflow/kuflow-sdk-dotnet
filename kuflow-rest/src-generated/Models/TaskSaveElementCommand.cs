...
namespace KuFlow.Rest.Models
{
    ...
    {
        /// <summary> Initializes a new instance of <see cref="TaskSaveElementCommand"/>. </summary>
        ...
        /// </param>
        internal TaskSaveElementCommand(string elementDefinitionCode, IList<TaskElementValue> elementValues)
        {
            ElementDefinitionCode = elementDefinitionCode;
