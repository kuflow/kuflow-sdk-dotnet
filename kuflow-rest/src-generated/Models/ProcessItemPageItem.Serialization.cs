...
{
    public partial class ProcessItemPageItem
    {
        internal static ProcessItemPageItem DeserializeProcessItemPageItem(JsonElement element)
        {
            ...
            return new ProcessItemPageItem(
                createdBy,
                createdAt,
                lastModifiedBy,
                lastModifiedAt,
        ...
        internal static new ProcessItemPageItem FromResponse(Response response)
        {
            using var document = JsonDocument.Parse(response.Content);
            return DeserializeProcessItemPageItem(document.RootElement);
        }
    }
}
