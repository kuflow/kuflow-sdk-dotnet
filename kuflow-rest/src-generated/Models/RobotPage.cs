...
namespace KuFlow.Rest.Models
{
  ...
  public partial class RobotPage : Page
  {
    ...
    internal RobotPage(PageMetadata metadata, IEnumerable<RobotPageItem> content)
      : base(metadata)
    {
    ...
    internal RobotPage(PageMetadata metadata, IReadOnlyList<RobotPageItem> content)
      : base(metadata)
    {
      Argument.AssertNotNull(metadata, nameof(metadata));
