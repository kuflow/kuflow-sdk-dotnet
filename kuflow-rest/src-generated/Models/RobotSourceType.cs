...
namespace KuFlow.Rest.Models
{
    ...
    public readonly partial struct RobotSourceType : IEquatable<RobotSourceType>
    {
        ...
        private const string ROBOTFRAMEWORKPYTHONWHEELValue = "ROBOT_FRAMEWORK_PYTHON_WHEEL";

        /// <summary> ROBOT_FRAMEWORK_PYTHON_WHEEL. </summary>
        public static RobotSourceType ROBOTFRAMEWORKPYTHONWHEEL { get; } = new RobotSourceType(ROBOTFRAMEWORKPYTHONWHEELValue);
