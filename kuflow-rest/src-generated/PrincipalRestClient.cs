...
namespace KuFlow.Rest
{
  internal partial class PrincipalRestClient
  {
    ...
    internal HttpMessage CreateFindPrincipalsRequest(
      int? size,
      int? page,
    ...
    )
    {
      ...
      if (
        tenantId != null
        && !(tenantId is ChangeTrackingList<Guid> changeTrackingList1 && changeTrackingList1.IsUndefined)
      )
      {
    ...
    ///
    /// </remarks>
    public async Task<Response<PrincipalPage>> FindPrincipalsAsync(
      int? size = null,
      int? page = null,
    ...
    ///
    /// </remarks>
    public Response<PrincipalPage> FindPrincipals(
      int? size = null,
      int? page = null,
      IEnumerable<string> sort = null,
      PrincipalType? type = null,
    ...
    public async Task<Response<Principal>> RetrievePrincipalAsync(
      Guid id,
      CancellationToken cancellationToken = default
    )
    {
