...
namespace KuFlow.Rest
{
  ...
  public partial class RobotClient
  {
    ...
    ///
    /// </remarks>
    internal virtual async Task<Response<RobotPage>> FindRobotsAsync(
      int? size = null,
      int? page = null,
      IEnumerable<string> sort = null,
      IEnumerable<Guid> tenantId = null,
      RobotFilterContext? filterContext = null,
    ...
    )
    {
      ...
      try
      {
        return await RestClient
          .FindRobotsAsync(size, page, sort, tenantId, filterContext, cancellationToken)
    ...
    ///
    /// </remarks>
    internal virtual Response<RobotPage> FindRobots(
      int? size = null,
      int? page = null,
      IEnumerable<string> sort = null,
      IEnumerable<Guid> tenantId = null,
    ...
    public virtual async Task<Response<Robot>> RetrieveRobotAsync(
      Guid id,
      CancellationToken cancellationToken = default
    )
    {
    ...
    public virtual async Task<Response<Stream>> DownloadRobotSourceCodeAsync(
      Guid id,
      CancellationToken cancellationToken = default
    )
    {
    ...
    public virtual async Task<Response<Stream>> DownloadRobotAssetAsync(
      Guid id,
      RobotAssetType type,
      string version,
    ...
    )
    {
      ...
      {
        return await RestClient
          .DownloadRobotAssetAsync(id, type, version, platform, architecture, cancellationToken)
          .ConfigureAwait(false);
      }
      catch (Exception e)
      {
    ...
    /// <param name="cancellationToken"> The cancellation token to use. </param>
    /// <remarks> Given a robot, download the requested asset. </remarks>
    public virtual Response<Stream> DownloadRobotAsset(
      Guid id,
      RobotAssetType type,
      string version,
      RobotAssetPlatform platform,
