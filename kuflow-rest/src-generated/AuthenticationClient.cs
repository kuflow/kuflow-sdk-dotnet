...
namespace KuFlow.Rest
{
  ...
  public partial class AuthenticationClient
  {
    ...
    public virtual async Task<Response<Authentication>> CreateAuthenticationAsync(
    ...
    )
    {
      ...
      try
      {
        return await RestClient
          .CreateAuthenticationAsync(authenticationCreateParams, cancellationToken)
    ...
    /// <param name="authenticationCreateParams"> Authentication to be created. </param>
    /// <param name="cancellationToken"> The cancellation token to use. </param>
    public virtual Response<Authentication> CreateAuthentication(
      AuthenticationCreateParams authenticationCreateParams,
      CancellationToken cancellationToken = default
    )
    {
