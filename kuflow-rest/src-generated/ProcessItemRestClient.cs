...
namespace KuFlow.Rest
{
    internal partial class ProcessItemRestClient
    {
        ...
        internal HttpMessage CreateUploadProcessItemTaskDataDocumentRequest(Guid id, string fileContentType, string fileName, string schemaPath, Stream file)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Post;
            ...
            uri.AppendPath("/process-items/", false);
            uri.AppendPath(id, true);
            uri.AppendPath("/task/data/~actions/upload-document", false);
        ...
        ///
        /// </remarks>
        public async Task<Response<DocumentReference>> UploadProcessItemTaskDataDocumentAsync(Guid id, string fileContentType, string fileName, string schemaPath, Stream file, CancellationToken cancellationToken = default)
        {
            ...
            using var message = CreateUploadProcessItemTaskDataDocumentRequest(id, fileContentType, fileName, schemaPath, file);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
        ...
        ///
        /// </remarks>
        public Response<DocumentReference> UploadProcessItemTaskDataDocument(Guid id, string fileContentType, string fileName, string schemaPath, Stream file, CancellationToken cancellationToken = default)
        {
            if (fileContentType == null)
            {
                throw new ArgumentNullException(nameof(fileContentType));
        ...
        internal HttpMessage CreateDownloadProcessItemTaskDataDocumentRequest(Guid id, string documentUri)
        {
            var message = _pipeline.CreateMessage();
            var request = message.Request;
            request.Method = RequestMethod.Get;
            ...
            uri.AppendPath("/process-items/", false);
            uri.AppendPath(id, true);
            uri.AppendPath("/task/data/~actions/download-document", false);
        ...
        public async Task<Response<Stream>> DownloadProcessItemTaskDataDocumentAsync(Guid id, string documentUri, CancellationToken cancellationToken = default)
        {
            if (documentUri == null)
            {
            ...
            using var message = CreateDownloadProcessItemTaskDataDocumentRequest(id, documentUri);
            await _pipeline.SendAsync(message, cancellationToken).ConfigureAwait(false);
            switch (message.Response.Status)
            {
                case 200:
        ...
        /// <exception cref="ArgumentNullException"> <paramref name="documentUri"/> is null. </exception>
        /// <remarks> Given a task, download a document from a json form data. </remarks>
        public Response<Stream> DownloadProcessItemTaskDataDocument(Guid id, string documentUri, CancellationToken cancellationToken = default)
        {
            if (documentUri == null)
            {
                throw new ArgumentNullException(nameof(documentUri));
