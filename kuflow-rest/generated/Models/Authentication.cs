...
namespace Kuflow.Rest.Models
{
    ...
    public partial class Authentication : AbstractAudited
    {
        ...
        internal Authentication(AuditedObjectType objectType, Guid? createdBy, DateTimeOffset? createdAt, Guid? lastModifiedBy, DateTimeOffset? lastModifiedAt, Guid? id, string type, string token, DateTimeOffset? expiredAt) : base(objectType, createdBy, createdAt, lastModifiedBy, lastModifiedAt)
        {
            Id = id;
            Type = type;
            Token = token;
