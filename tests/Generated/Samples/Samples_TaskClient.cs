...
namespace Kuflow.Rest.Samples
{
    public class Samples_TaskClient
    {
        ...
        public void Example_FindTasks_AllParameters()
        {
            ...
            Response response = client.FindTasks(1234, 1234, new string[] { "<sort>" }, new Guid[] { Guid.NewGuid() }, new string[] { "<state>" }, new string[] { "<taskDefinitionCode>" }, new RequestContext());
            ...
            Console.WriteLine(result.GetProperty("content")[0].GetProperty("taskDefinition").GetProperty("version").ToString());
            ...
            Console.WriteLine(result.GetProperty("content")[0].GetProperty("owner").GetProperty("user").GetProperty("id").ToString());
            Console.WriteLine(result.GetProperty("content")[0].GetProperty("owner").GetProperty("user").GetProperty("email").ToString());
            Console.WriteLine(result.GetProperty("content")[0].GetProperty("owner").GetProperty("application").GetProperty("id").ToString());
            Console.WriteLine(result.GetProperty("content")[0].GetProperty("objectType").ToString());
        ...
        public async Task Example_FindTasks_AllParameters_Async()
        {
            ...
            Response response = await client.FindTasksAsync(1234, 1234, new string[] { "<sort>" }, new Guid[] { Guid.NewGuid() }, new string[] { "<state>" }, new string[] { "<taskDefinitionCode>" }, new RequestContext());
        ...
        new {
            ...
            Response response = await client.CreateTaskAsync(RequestContent.Create(data), "<activityToken>", new RequestContext());
        ...
        public async Task Example_ActionsTaskAssign_AllParameters_Async()
        {
            ...
            Response response = await client.ActionsTaskAssignAsync(Guid.NewGuid(), RequestContent.Create(data), new RequestContext());
        ...
        new {
            ...
            Response response = client.ActionsTaskSaveElement(Guid.NewGuid(), RequestContent.Create(data), new RequestContext());
        ...
        new {
            ...
            Response response = await client.ActionsTaskSaveElementAsync(Guid.NewGuid(), RequestContent.Create(data), new RequestContext());
        ...
        public void Example_ActionsTaskSaveElementValueDocument()
        {
            ...
            Response response = client.ActionsTaskSaveElementValueDocument(Guid.NewGuid(), "<fileContentType>", "<fileName>", "<elementDefinitionCode>", RequestContent.Create(data));
        ...
        public void Example_ActionsTaskSaveElementValueDocument_AllParameters()
        {
            ...
            Response response = client.ActionsTaskSaveElementValueDocument(Guid.NewGuid(), "<fileContentType>", "<fileName>", "<elementDefinitionCode>", RequestContent.Create(data), Guid.NewGuid(), true, new RequestContext());
        ...
        public async Task Example_ActionsTaskSaveElementValueDocument_Async()
        {
            ...
            Response response = await client.ActionsTaskSaveElementValueDocumentAsync(Guid.NewGuid(), "<fileContentType>", "<fileName>", "<elementDefinitionCode>", RequestContent.Create(data));
        ...
        public async Task Example_ActionsTaskSaveElementValueDocument_AllParameters_Async()
        {
            ...
            Response response = await client.ActionsTaskSaveElementValueDocumentAsync(Guid.NewGuid(), "<fileContentType>", "<fileName>", "<elementDefinitionCode>", RequestContent.Create(data), Guid.NewGuid(), true, new RequestContext());
        ...
        public void Example_ActionsTaskDeleteElement_AllParameters()
        {
            ...
            Response response = client.ActionsTaskDeleteElement(Guid.NewGuid(), RequestContent.Create(data), new RequestContext());
        ...
        public async Task Example_ActionsTaskDeleteElement_AllParameters_Async()
        {
            ...
            Response response = await client.ActionsTaskDeleteElementAsync(Guid.NewGuid(), RequestContent.Create(data), new RequestContext());
        ...
        public void Example_ActionsTaskDeleteElementValueDocument()
        {
            ...
            var data = new
            {
                documentId = "73f411fe-4f43-4b4b-9cbd-6828d8f4cf9a",
            };
        ...
        public void Example_ActionsTaskDeleteElementValueDocument_AllParameters()
        {
            ...
            Response response = client.ActionsTaskDeleteElementValueDocument(Guid.NewGuid(), RequestContent.Create(data), new RequestContext());
        ...
        public async Task Example_ActionsTaskDeleteElementValueDocument_Async()
        {
            ...
            Response response = await client.ActionsTaskDeleteElementValueDocumentAsync(Guid.NewGuid(), RequestContent.Create(data));
        ...
        public async Task Example_ActionsTaskDeleteElementValueDocument_AllParameters_Async()
        {
            ...
            Response response = await client.ActionsTaskDeleteElementValueDocumentAsync(Guid.NewGuid(), RequestContent.Create(data), new RequestContext());
        ...
        public void Example_ActionsTaskDownloadElementValueDocument_AllParameters()
        {
            ...
            Response response = client.ActionsTaskDownloadElementValueDocument(Guid.NewGuid(), Guid.NewGuid(), new RequestContext());
            if (response.ContentStream != null)
            {
                using (Stream outFileStream = File.OpenWrite("<filePath>"))
                {
        ...
        public async Task Example_ActionsTaskDownloadElementValueDocument_AllParameters_Async()
        {
            ...
            Response response = await client.ActionsTaskDownloadElementValueDocumentAsync(Guid.NewGuid(), Guid.NewGuid(), new RequestContext());
            if (response.ContentStream != null)
            {
                using (Stream outFileStream = File.OpenWrite("<filePath>"))
                {
        ...
        public void Example_ActionsTaskDownloadElementValueRendered_AllParameters()
        {
            ...
            Response response = client.ActionsTaskDownloadElementValueRendered(Guid.NewGuid(), "<elementDefinitionCode>", new RequestContext());
            if (response.ContentStream != null)
            {
                using (Stream outFileStream = File.OpenWrite("<filePath>"))
                {
        ...
        public async Task Example_ActionsTaskDownloadElementValueRendered_Async()
        {
            ...
            Response response = await client.ActionsTaskDownloadElementValueRenderedAsync(Guid.NewGuid(), "<elementDefinitionCode>");
            if (response.ContentStream != null)
            {
                using (Stream outFileStream = File.OpenWrite("<filePath>"))
                {
        ...
        public async Task Example_ActionsTaskDownloadElementValueRendered_AllParameters_Async()
        {
            ...
            Response response = await client.ActionsTaskDownloadElementValueRenderedAsync(Guid.NewGuid(), "<elementDefinitionCode>", new RequestContext());
            if (response.ContentStream != null)
            {
                using (Stream outFileStream = File.OpenWrite("<filePath>"))
                {
        ...
        public void Example_ActionsTaskAppendLog_AllParameters()
        {
            ...
            Response response = client.ActionsTaskAppendLog(Guid.NewGuid(), RequestContent.Create(data), new RequestContext());
        ...
        public async Task Example_ActionsTaskAppendLog_AllParameters_Async()
        {
            ...
            Response response = await client.ActionsTaskAppendLogAsync(Guid.NewGuid(), RequestContent.Create(data), new RequestContext());
