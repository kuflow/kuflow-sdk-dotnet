...
namespace Kuflow.Rest.Samples
{
    public class Samples_PrincipalClient
    {
        ...
        public void Example_FindPrincipals_AllParameters()
        {
            ...
            Response response = client.FindPrincipals(1234, 1234, new string[] { "<sort>" }, "<type>", new Guid[] { Guid.NewGuid() }, new RequestContext());
        ...
        public async Task Example_FindPrincipals_AllParameters_Async()
        {
            ...
            Response response = await client.FindPrincipalsAsync(1234, 1234, new string[] { "<sort>" }, "<type>", new Guid[] { Guid.NewGuid() }, new RequestContext());
