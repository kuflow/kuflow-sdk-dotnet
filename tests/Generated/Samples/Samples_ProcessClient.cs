...
namespace Kuflow.Rest.Samples
{
  public class Samples_ProcessClient
  {
    ...
    public void Example_FindProcesses_AllParameters()
    {
      ...
      Console.WriteLine(result.GetProperty("content")[0].GetProperty("processDefinition").GetProperty("id").ToString());
      Console.WriteLine(
        result.GetProperty("content")[0].GetProperty("processDefinition").GetProperty("version").ToString()
      );
      Console.WriteLine(
        result.GetProperty("content")[0].GetProperty("processDefinition").GetProperty("name").ToString()
      );
      Console.WriteLine(
        result
      ...
      Console.WriteLine(
        result.GetProperty("content")[0].GetProperty("initiator").GetProperty("user").GetProperty("id").ToString()
      );
      Console.WriteLine(
        result.GetProperty("content")[0].GetProperty("initiator").GetProperty("user").GetProperty("email").ToString()
      );
      Console.WriteLine(
        result
          .GetProperty("content")[0]
          .GetProperty("initiator")
    ...
    public void Example_CreateProcess()
    {
      ...
      var data = new
      {
        processDefinition = new { id = "73f411fe-4f43-4b4b-9cbd-6828d8f4cf9a", },
        objectType = "Process",
      };
    ...
    public void Example_CreateProcess_AllParameters()
    {
      ...
      var data = new
      {
        ...
        relatedProcess = new
        {
          incoming = new[] { "73f411fe-4f43-4b4b-9cbd-6828d8f4cf9a" },
          outcoming = new[] { "73f411fe-4f43-4b4b-9cbd-6828d8f4cf9a" },
        },
        objectType = "Process",
    ...
    public void Example_ActionsProcessChangeInitiator_AllParameters()
    {
      ...
      Response response = client.ActionsProcessChangeInitiator(
        Guid.NewGuid(),
    ...
    public async Task Example_ActionsProcessChangeInitiator_AllParameters_Async()
    {
      ...
      Response response = await client.ActionsProcessChangeInitiatorAsync(
        Guid.NewGuid(),
        RequestContent.Create(data),
        new RequestContext()
      );
    ...
    public void Example_ActionsProcessSaveElement_AllParameters()
    {
      ...
      Response response = client.ActionsProcessSaveElement(
        Guid.NewGuid(),
        RequestContent.Create(data),
        new RequestContext()
      );
    ...
    public async Task Example_ActionsProcessSaveElement_AllParameters_Async()
    {
      ...
      Response response = await client.ActionsProcessSaveElementAsync(
        Guid.NewGuid(),
        RequestContent.Create(data),
        new RequestContext()
      );
    ...
    public void Example_ActionsProcessDeleteElement_AllParameters()
    {
      ...
      Response response = client.ActionsProcessDeleteElement(
        Guid.NewGuid(),
        RequestContent.Create(data),
        new RequestContext()
      );
    ...
    public async Task Example_ActionsProcessDeleteElement_AllParameters_Async()
    {
      ...
      Response response = await client.ActionsProcessDeleteElementAsync(
        Guid.NewGuid(),
        RequestContent.Create(data),
        new RequestContext()
      );
    ...
    public void Example_ActionsProcessSaveUserActionValueDocument()
    {
      ...
      Response response = client.ActionsProcessSaveUserActionValueDocument(
        Guid.NewGuid(),
        "<fileContentType>",
        "<fileName>",
        Guid.NewGuid(),
    ...
    public async Task Example_ActionsProcessSaveUserActionValueDocument_Async()
    {
      ...
      Response response = await client.ActionsProcessSaveUserActionValueDocumentAsync(
        Guid.NewGuid(),
        "<fileContentType>",
        "<fileName>",
        Guid.NewGuid(),
